...
entity axi_qpsk_generator_ctrl is
  port (
    ...
    rf_ch_sel : in std_logic_vector( 32-1 downto 0 );
    ...
    rf_ch_sel_out : out std_logic_vector( 2-1 downto 0 )
  );
end axi_qpsk_generator_ctrl;
architecture structural of axi_qpsk_generator_ctrl is 
  ...
  signal slice13_y_net : std_logic_vector( 2-1 downto 0 );
  ...
  signal rf_ch_sel_net : std_logic_vector( 32-1 downto 0 );
begin
  ...
  rf_ch_sel_net <= rf_ch_sel;
  reinterpret : entity xil_defaultlib.sysgen_reinterpret_9fe31e1785 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  slice : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice1 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice10 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice11 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice12 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice2 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice3 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice4 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice5 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice6 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice7 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice8 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice9 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  slice13 : entity xil_defaultlib.axi_qpsk_generator_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 1,
    x_width => 32,
...
-- Generated from Simulink block AXI_QPSK_Tx/AXI_QPSK_Generator/M_AXIS_CH0
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_ch0 is
  port (
    ...
    m_rf0_axis_tready : in std_logic_vector( 1-1 downto 0 )
  );
end axi_qpsk_generator_m_axis_ch0;
architecture structural of axi_qpsk_generator_m_axis_ch0 is 
  signal logical2_y_net : std_logic_vector( 1-1 downto 0 );
  signal mux_y_net : std_logic_vector( 32-1 downto 0 );
  signal m_rf0_axis_tready_net : std_logic_vector( 1-1 downto 0 );
  signal logical1_y_net : std_logic_vector( 1-1 downto 0 );
begin
  mux_y_net <= tdata_in;
  logical1_y_net <= tvalid_in;
  logical2_y_net <= tlast_in;
  m_rf0_axis_tready_net <= m_rf0_axis_tready;
end structural;
-- Generated from Simulink block AXI_QPSK_Tx/AXI_QPSK_Generator/M_AXIS_CH1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_ch1 is
  port (
    tdata_in : in std_logic_vector( 32-1 downto 0 );
    tvalid_in : in std_logic_vector( 1-1 downto 0 );
    tlast_in : in std_logic_vector( 1-1 downto 0 );
    m_rf1_axis_tready : in std_logic_vector( 1-1 downto 0 )
  );
end axi_qpsk_generator_m_axis_ch1;
architecture structural of axi_qpsk_generator_m_axis_ch1 is 
  signal logical1_y_net : std_logic_vector( 1-1 downto 0 );
  signal mux1_y_net : std_logic_vector( 32-1 downto 0 );
  signal logical2_y_net : std_logic_vector( 1-1 downto 0 );
  signal m_rf1_axis_tready_net : std_logic_vector( 1-1 downto 0 );
begin
  mux1_y_net <= tdata_in;
  logical1_y_net <= tvalid_in;
  logical2_y_net <= tlast_in;
  m_rf1_axis_tready_net <= m_rf1_axis_tready;
end structural;
-- Generated from Simulink block AXI_QPSK_Tx/AXI_QPSK_Generator/M_AXIS_CH2
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_ch2 is
  port (
    tdata_in : in std_logic_vector( 32-1 downto 0 );
    tvalid_in : in std_logic_vector( 1-1 downto 0 );
    tlast_in : in std_logic_vector( 1-1 downto 0 );
    m_rf2_axis_tready : in std_logic_vector( 1-1 downto 0 )
  );
end axi_qpsk_generator_m_axis_ch2;
architecture structural of axi_qpsk_generator_m_axis_ch2 is 
  signal logical2_y_net : std_logic_vector( 1-1 downto 0 );
  signal logical1_y_net : std_logic_vector( 1-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal m_rf2_axis_tready_net : std_logic_vector( 1-1 downto 0 );
begin
  mux2_y_net <= tdata_in;
  logical1_y_net <= tvalid_in;
  logical2_y_net <= tlast_in;
  m_rf2_axis_tready_net <= m_rf2_axis_tready;
end structural;
-- Generated from Simulink block AXI_QPSK_Tx/AXI_QPSK_Generator/M_AXIS_CH3
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_ch3 is
  port (
    tdata_in : in std_logic_vector( 32-1 downto 0 );
    tvalid_in : in std_logic_vector( 1-1 downto 0 );
    tlast_in : in std_logic_vector( 1-1 downto 0 );
    m_rf3_axis_tready : in std_logic_vector( 1-1 downto 0 )
  );
end axi_qpsk_generator_m_axis_ch3;
architecture structural of axi_qpsk_generator_m_axis_ch3 is 
  signal logical2_y_net : std_logic_vector( 1-1 downto 0 );
  signal m_rf3_axis_tready_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  logical1_y_net <= tvalid_in;
  logical2_y_net <= tlast_in;
  m_rf3_axis_tready_net <= m_rf3_axis_tready;
end structural;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_fft is
  port (
    tdata_in : in std_logic_vector( 32-1 downto 0 );
    tvalid_in : in std_logic_vector( 1-1 downto 0 );
    tlast_in : in std_logic_vector( 1-1 downto 0 );
...
end axi_qpsk_generator_m_axis_fft;
architecture structural of axi_qpsk_generator_m_axis_fft is 
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_symbol is
  port (
...
end axi_qpsk_generator_m_axis_symbol;
architecture structural of axi_qpsk_generator_m_axis_symbol is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_time is
  port (
    tdata_in : in std_logic_vector( 32-1 downto 0 );
    tvalid_in : in std_logic_vector( 1-1 downto 0 );
    tlast_in : in std_logic_vector( 1-1 downto 0 );
...
end axi_qpsk_generator_m_axis_time;
architecture structural of axi_qpsk_generator_m_axis_time is 
  signal register5_q_net : std_logic_vector( 32-1 downto 0 );
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
  signal register3_q_net : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_axi_write_interface is
  port (
...
end axi_qpsk_generator_axi_write_interface;
architecture structural of axi_qpsk_generator_axi_write_interface is 
...
begin
  ...
  ce_net <= ce_1;
  we_ce_net <= ce_6400;
  constant_x0 : entity xil_defaultlib.sysgen_constant_3c4e9aa243 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert : entity xil_defaultlib.axi_qpsk_generator_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  convert1 : entity xil_defaultlib.axi_qpsk_generator_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  convert2 : entity xil_defaultlib.axi_qpsk_generator_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  convert3 : entity xil_defaultlib.axi_qpsk_generator_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  convert5 : entity xil_defaultlib.axi_qpsk_generator_xlconvert 
  generic map (
    bool_conversion => 1,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  counter : entity xil_defaultlib.axi_qpsk_generator_xlcounter_free 
  generic map (
    core_name0 => "axi_qpsk_generator_c_counter_binary_v12_0_i0",
    op_arith => xlUnsigned,
    op_width => 32
  )
  port map (
  ...
  fifo : entity xil_defaultlib.axi_qpsk_generator_xlfifogen_u 
  generic map (
    core_name0 => "axi_qpsk_generator_fifo_generator_i0",
    data_count_width => 12,
    data_width => 32,
    extra_registers => 1,
    has_ae => 0,
  ...
  inverter : entity xil_defaultlib.sysgen_inverter_805010cdea 
  port map (
    clr => '0',
  ...
  inverter1 : entity xil_defaultlib.sysgen_inverter_805010cdea 
  port map (
    clr => '0',
  ...
  logical : entity xil_defaultlib.sysgen_logical_f228941c57 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical1 : entity xil_defaultlib.sysgen_logical_666441e406 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical2 : entity xil_defaultlib.sysgen_logical_f228941c57 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical3 : entity xil_defaultlib.sysgen_logical_666441e406 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mcode : entity xil_defaultlib.sysgen_mcode_block_7c59eeca0a 
  port map (
    clr => '0',
  ...
  register3 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  register4 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  register5 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 32,
  ...
  relational : entity xil_defaultlib.sysgen_relational_d6f1239b8b 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_8ea619ff44 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_symbol_ctrl is
  port (
...
end axi_qpsk_generator_m_axis_symbol_ctrl;
architecture structural of axi_qpsk_generator_m_axis_symbol_ctrl is 
...
begin
  ...
  ce_net <= ce_1;
  we_ce_net <= ce_6400;
  axi_write_interface : entity xil_defaultlib.axi_qpsk_generator_axi_write_interface 
  port map (
  ...
  concat : entity xil_defaultlib.sysgen_concat_2c9ffb108b 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret : entity xil_defaultlib.sysgen_reinterpret_15777e6df9 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_15777e6df9 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_posthb_time_domain is
  port (
...
end axi_qpsk_generator_posthb_time_domain;
architecture structural of axi_qpsk_generator_posthb_time_domain is 
  signal mux1_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice10_y_net : std_logic_vector( 1-1 downto 0 );
  signal slice9_y_net : std_logic_vector( 1-1 downto 0 );
  signal m_time_axis_tready_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  ce_net <= ce_1;
  we_ce_net <= ce_6400;
  m_axis_symbol_ctrl : entity xil_defaultlib.axi_qpsk_generator_m_axis_symbol_ctrl 
  port map (
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_axi_write_interface_x0 is
  port (
    int_reset : in std_logic_vector( 1-1 downto 0 );
    transfer : in std_logic_vector( 1-1 downto 0 );
    auto_restart : in std_logic_vector( 1-1 downto 0 );
...
end axi_qpsk_generator_axi_write_interface_x0;
architecture structural of axi_qpsk_generator_axi_write_interface_x0 is 
  signal relational_op_net : std_logic_vector( 1-1 downto 0 );
  signal convert2_dout_net : std_logic_vector( 1-1 downto 0 );
  signal convert3_dout_net : std_logic_vector( 1-1 downto 0 );
  signal mcode_re_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  we_ce_net <= ce_6400;
  constant_x0 : entity xil_defaultlib.sysgen_constant_340eb4c17d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert4 : entity xil_defaultlib.axi_qpsk_generator_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  fifo : entity xil_defaultlib.axi_qpsk_generator_xlfifogen_u 
  generic map (
    core_name0 => "axi_qpsk_generator_fifo_generator_i1",
    data_count_width => 13,
    data_width => 32,
    extra_registers => 1,
    has_ae => 0,
  ...
  mcode : entity xil_defaultlib.sysgen_mcode_block_b116b16118 
  port map (
    clr => '0',
    axiwrite => convert_dout_net,
    tlast => convert1_dout_net,
  ...
  register1 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  relational : entity xil_defaultlib.sysgen_relational_25db20f9a9 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  up_sample1 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 0,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  up_sample2 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 0,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_post_hb_fft is
  port (
...
end axi_qpsk_generator_post_hb_fft;
architecture structural of axi_qpsk_generator_post_hb_fft is 
  signal m_fft_axis_tready_net : std_logic_vector( 1-1 downto 0 );
  signal slice2_y_net : std_logic_vector( 1-1 downto 0 );
  signal delay_hb1_q_net_x0 : std_logic_vector( 1-1 downto 0 );
  signal slice7_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  src_clk_net <= clk_6400;
  we_ce_net <= ce_6400;
  axi_write_interface : entity xil_defaultlib.axi_qpsk_generator_axi_write_interface_x0 
  port map (
  ...
  absolute : entity xil_defaultlib.sysgen_abs_ab08ff3ca4 
  port map (
    clr => '0',
    a => fft1_op_re_net,
    clk => src_clk_net,
  ...
  absolute1 : entity xil_defaultlib.sysgen_abs_ab08ff3ca4 
  port map (
    clr => '0',
    a => fft1_op_im_net,
    clk => src_clk_net,
  ...
  cmult : entity xil_defaultlib.axi_qpsk_generator_xlcmult 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 31,
    a_width => 32,
    ...
    c_b_width => 32,
    c_output_width => 64,
    core_name0 => "axi_qpsk_generator_mult_gen_v12_0_i0",
    extra_registers => 0,
    multsign => 1,
    overflow => 1,
    p_arith => xlUnsigned,
  ...
  complex_abs : entity xil_defaultlib.axi_qpsk_generator_xladdsub 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 31,
    a_width => 32,
    ...
    c_latency => 1,
    c_output_width => 65,
    core_name0 => "axi_qpsk_generator_c_addsub_v12_0_i0",
    extra_registers => 0,
    full_s_arith => 1,
    full_s_width => 65,
    latency => 1,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_eabacd725f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_ef9f5e9929 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  counter : entity xil_defaultlib.axi_qpsk_generator_xlcounter_limit 
  generic map (
    cnt_15_0 => 1023,
    cnt_31_16 => 0,
    cnt_47_32 => 0,
    cnt_63_48 => 0,
    core_name0 => "axi_qpsk_generator_c_counter_binary_v12_0_i1",
    count_limited => 0,
    op_arith => xlUnsigned,
    op_width => 10
  )
  ...
  delay : entity xil_defaultlib.axi_qpsk_generator_xldelay 
  generic map (
    latency => 2204,
    reg_retiming => 0,
    reset => 0,
  ...
  delay1 : entity xil_defaultlib.axi_qpsk_generator_xldelay 
  generic map (
    latency => 2204,
    reg_retiming => 0,
    reset => 0,
  ...
  fft1 : entity xil_defaultlib.xlaxi_qpsk_generator_xfft_v9_1_i0_ec3014ae608cdfed73d7eb61bd693ebb 
  port map (
  ...
  max : entity xil_defaultlib.sysgen_mux_6328512e05 
  port map (
    clr => '0',
  ...
  min : entity xil_defaultlib.sysgen_mux_6328512e05 
  port map (
    clr => '0',
    sel => relational1_op_net,
    d0 => absolute1_op_net,
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_42f1ae6479 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  register_x0 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
  ...
  register2 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  register6 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  register7 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  register8 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_9fe31e1785 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational : entity xil_defaultlib.sysgen_relational_39cb656b9c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational2 : entity xil_defaultlib.sysgen_relational_c6e94a35a2 
  port map (
    clr => '0',
    a => complex_abs_s_net,
    b => constant2_op_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_qpsk_symbol_mapper is
  port (
...
end axi_qpsk_generator_qpsk_symbol_mapper;
architecture structural of axi_qpsk_generator_qpsk_symbol_mapper is 
...
begin
  ...
  clk_net <= clk_51200;
  ce_net <= ce_51200;
  constant_x0 : entity xil_defaultlib.sysgen_constant_4cacdbdd74 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_3476f8b528 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_4cacdbdd74 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_3476f8b528 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux : entity xil_defaultlib.sysgen_mux_5b2f2ad93c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_5b2f2ad93c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block AXI_QPSK_Tx/AXI_QPSK_Generator/RF_Output/channel_selector
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_channel_selector is
  port (
    ch_sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    ch0_out : out std_logic_vector( 32-1 downto 0 );
    ch1_out : out std_logic_vector( 32-1 downto 0 );
    ch2_out : out std_logic_vector( 32-1 downto 0 );
    ch3_out : out std_logic_vector( 32-1 downto 0 )
  );
end axi_qpsk_generator_channel_selector;
architecture structural of axi_qpsk_generator_channel_selector is 
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal mux3_y_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
begin
  ...
  ch2_out <= mux2_y_net;
  ch3_out <= mux3_y_net;
  slice13_y_net <= ch_sel;
  concat_y_net <= data_in;
  clk_net <= clk_1;
  ce_net <= ce_1;
  constant3 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant4 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_f928c2c324 
  port map (
    clr => '0',
    sel => slice13_y_net,
    d0 => constant3_op_net,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant10 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant11 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant9 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant6 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant7 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant8 : entity xil_defaultlib.sysgen_constant_48c15e0ecf 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux2 : entity xil_defaultlib.sysgen_mux_f928c2c324 
  port map (
    clr => '0',
    sel => slice13_y_net,
    d0 => constant6_op_net,
  ...
  mux3 : entity xil_defaultlib.sysgen_mux_f928c2c324 
  port map (
    clr => '0',
    sel => slice13_y_net,
    d0 => constant9_op_net,
  ...
  mux : entity xil_defaultlib.sysgen_mux_f928c2c324 
  port map (
    clr => '0',
    sel => slice13_y_net,
    d0 => concat_y_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_rf_output is
  port (
    ...
    rf_ch_sel : in std_logic_vector( 2-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    ch0_out : out std_logic_vector( 32-1 downto 0 );
...
end axi_qpsk_generator_rf_output;
architecture structural of axi_qpsk_generator_rf_output is 
...
begin
  ...
  ch2_out <= mux2_y_net;
  ch3_out <= mux3_y_net;
  delay5_q_net <= rf_i_data;
  delay3_q_net_x0 <= rf_i_valid;
  delay4_q_net_x0 <= rf_i_last;
  delay5_q_net_x0 <= rf_q_data;
  delay3_q_net <= rf_q_valid;
  delay4_q_net <= rf_q_last;
  slice13_y_net <= rf_ch_sel;
  clk_net <= clk_1;
  ce_net <= ce_1;
  channel_selector : entity xil_defaultlib.axi_qpsk_generator_channel_selector 
  port map (
    ch_sel => slice13_y_net,
  ...
  logical2 : entity xil_defaultlib.sysgen_logical_666441e406 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_random_data_generator is
  port (
...
end axi_qpsk_generator_random_data_generator;
architecture structural of axi_qpsk_generator_random_data_generator is 
  signal register3_q_net : std_logic_vector( 1-1 downto 0 );
  signal register_q_net : std_logic_vector( 2-1 downto 0 );
  signal clk_net : std_logic;
...
begin
  ...
  clk_net <= clk_51200;
  ce_net <= ce_51200;
  concat : entity xil_defaultlib.sysgen_concat_13a1cf5582 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  lfsr : entity xil_defaultlib.sysgen_lfsr_ec6e4dafc8 
  port map (
    clr => '0',
    rst => slice1_y_net,
    en => logical1_y_net,
  ...
  lfsr1 : entity xil_defaultlib.sysgen_lfsr_462c350d8a 
  port map (
    clr => '0',
    rst => slice1_y_net,
    en => logical1_y_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_axi_write_interface_x1 is
  port (
    int_reset : in std_logic_vector( 1-1 downto 0 );
    transfer : in std_logic_vector( 1-1 downto 0 );
    auto_restart : in std_logic_vector( 1-1 downto 0 );
...
end axi_qpsk_generator_axi_write_interface_x1;
architecture structural of axi_qpsk_generator_axi_write_interface_x1 is 
...
begin
  ...
  fifo : entity xil_defaultlib.axi_qpsk_generator_xlfifogen_u 
  generic map (
    core_name0 => "axi_qpsk_generator_fifo_generator_i2",
    data_count_width => 12,
    data_width => 4,
    extra_registers => 1,
    has_ae => 0,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_m_axis_symbol_ctrl_x0 is
  port (
...
end axi_qpsk_generator_m_axis_symbol_ctrl_x0;
architecture structural of axi_qpsk_generator_m_axis_symbol_ctrl_x0 is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
  signal register2_q_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  ce_net_x0 <= ce_1;
  ce_net <= ce_51200;
  axi_write_interface : entity xil_defaultlib.axi_qpsk_generator_axi_write_interface_x1 
  port map (
  ...
  concat : entity xil_defaultlib.sysgen_concat_7daf579356 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret : entity xil_defaultlib.sysgen_reinterpret_2919a97bb3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_2919a97bb3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_symbol_2_output is
  port (
...
end axi_qpsk_generator_symbol_2_output;
architecture structural of axi_qpsk_generator_symbol_2_output is 
  signal slice3_y_net : std_logic_vector( 1-1 downto 0 );
  signal packetsizesymbol_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal m_symbol_axis_tready_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  ce_net_x0 <= ce_1;
  ce_net <= ce_51200;
  m_axis_symbol_ctrl : entity xil_defaultlib.axi_qpsk_generator_m_axis_symbol_ctrl_x0 
  port map (
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_txinterp_i is
  port (
...
end axi_qpsk_generator_txinterp_i;
architecture structural of axi_qpsk_generator_txinterp_i is 
  signal delay5_q_net : std_logic_vector( 16-1 downto 0 );
  signal delay3_q_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  ce_net_x1 <= ce_51200;
  cic_compiler_4_0 : entity xil_defaultlib.xlcic_compiler_5f5feed7b4afc25b43f342186cf14fe8 
  port map (
  ...
  generic map (
    ...
    c_b_width => 16,
    c_output_width => 33,
    core_name0 => "axi_qpsk_generator_mult_gen_v12_0_i1",
    extra_registers => 0,
    multsign => 2,
    overflow => 1,
    p_arith => xlSigned,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_4aa88150ab 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  delay_cic1 : entity xil_defaultlib.sysgen_delay_7e96a0a1d5 
  port map (
    clr => '0',
  ...
  delay_cic2 : entity xil_defaultlib.sysgen_delay_2dc66d11f5 
  port map (
    clr => '0',
  ...
  delay_ciccomp1 : entity xil_defaultlib.sysgen_delay_d91cc87a50 
  port map (
    clr => '0',
  ...
  delay_hb1 : entity xil_defaultlib.sysgen_delay_2dc66d11f5 
  port map (
    clr => '0',
    d => upsample_hb_q_net,
  ...
  delay_rrc2 : entity xil_defaultlib.sysgen_delay_d02abc7402 
  port map (
    clr => '0',
  ...
  delay3 : entity xil_defaultlib.sysgen_delay_42be98228f 
  port map (
    clr => '0',
    d => delay_cic1_q_net,
    rst => upsample_cic3_q_net,
  ...
  delay4 : entity xil_defaultlib.sysgen_delay_42be98228f 
  port map (
    clr => '0',
    d => inverter1_op_net,
    rst => upsample_cic3_q_net,
  ...
  delay5 : entity xil_defaultlib.sysgen_delay_f5cb39b94d 
  port map (
    clr => '0',
    d => mux2_y_net,
    rst => upsample_cic3_q_net,
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_807809c617f19c08074d2701798011c4 
  port map (
  ...
  fir_compiler_7_2_2 : entity xil_defaultlib.xlfir_compiler_2e4bd1c2628b94012423905c7b22f1a6 
  port map (
  ...
  fir_compiler_7_2_3 : entity xil_defaultlib.xlfir_compiler_9e4f64877b415982c3f02f665a61b37c 
  port map (
  ...
  mult : entity xil_defaultlib.axi_qpsk_generator_xlmult 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 32,
    a_width => 32,
    ...
    c_output_width => 48,
    c_type => 0,
    core_name0 => "axi_qpsk_generator_mult_gen_v12_0_i2",
    extra_registers => 0,
    multsign => 2,
    overflow => 1,
    p_arith => xlSigned,
  ...
  mult1 : entity xil_defaultlib.axi_qpsk_generator_xlmult 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 32,
    a_width => 32,
  ...
  mux : entity xil_defaultlib.sysgen_mux_4fc3633dd8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_4fc3633dd8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux2 : entity xil_defaultlib.sysgen_mux_4fc3633dd8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational : entity xil_defaultlib.sysgen_relational_8ea619ff44 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  shift : entity xil_defaultlib.sysgen_shift_6f018ea983 
  port map (
    clr => '0',
  ...
  shift3 : entity xil_defaultlib.sysgen_shift_274fd616f5 
  port map (
    clr => '0',
  ...
  upsample_cic : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_cic1 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_cic2 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_cic3 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_cic4 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 32,
  ...
  upsample_cic6 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_ciccomp : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_ciccomp1 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_ciccomp2 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_hb : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_hb1 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_hb2 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_rrc : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_rrc1 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
  ...
  upsample_rrc2 : entity xil_defaultlib.axi_qpsk_generator_xlusamp 
  generic map (
    copy_samples => 1,
    d_arith => xlUnsigned,
    d_bin_pt => 0,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_txinterp_q is
  port (
    input_symbols : in std_logic_vector( 2-1 downto 0 );
    reset : in std_logic_vector( 1-1 downto 0 );
    tready : in std_logic_vector( 1-1 downto 0 );
...
end axi_qpsk_generator_txinterp_q;
architecture structural of axi_qpsk_generator_txinterp_q is 
  signal clk_net : std_logic;
  signal slice1_y_net : std_logic_vector( 1-1 downto 0 );
  signal delay_hb1_q_net : std_logic_vector( 1-1 downto 0 );
  signal ce_net : std_logic;
...
-- Generated from Simulink block AXI_QPSK_Tx/AXI_QPSK_Generator_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_struct is
  port (
    autorestartfft : in std_logic_vector( 32-1 downto 0 );
    autorestartsymbol : in std_logic_vector( 32-1 downto 0 );
    autorestarttime : in std_logic_vector( 32-1 downto 0 );
    ...
    clk_51200 : in std_logic;
    ce_51200 : in std_logic;
    m_rf0_axis_tdata : out std_logic_vector( 32-1 downto 0 );
    m_rf0_axis_tlast : out std_logic_vector( 1-1 downto 0 );
    m_rf0_axis_tvalid : out std_logic_vector( 1-1 downto 0 );
    m_rf1_axis_tdata : out std_logic_vector( 32-1 downto 0 );
    m_rf1_axis_tlast : out std_logic_vector( 1-1 downto 0 );
    m_rf1_axis_tvalid : out std_logic_vector( 1-1 downto 0 );
    m_rf2_axis_tdata : out std_logic_vector( 32-1 downto 0 );
    m_rf2_axis_tlast : out std_logic_vector( 1-1 downto 0 );
    m_rf2_axis_tvalid : out std_logic_vector( 1-1 downto 0 );
    m_rf3_axis_tdata : out std_logic_vector( 32-1 downto 0 );
    m_rf3_axis_tlast : out std_logic_vector( 1-1 downto 0 );
    m_rf3_axis_tvalid : out std_logic_vector( 1-1 downto 0 );
...
end axi_qpsk_generator_struct;
architecture structural of axi_qpsk_generator_struct is 
  signal enable_net : std_logic_vector( 32-1 downto 0 );
  signal lfsr_rst_net : std_logic_vector( 32-1 downto 0 );
  signal autorestartsymbol_net : std_logic_vector( 32-1 downto 0 );
  signal autorestarttime_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  transfertime_net <= transfertime;
  rf_ch_sel_net <= rf_ch_sel;
  m_rf0_axis_tdata <= mux_y_net;
  m_rf0_axis_tlast <= logical2_y_net;
  m_rf0_axis_tready_net <= m_rf0_axis_tready;
  m_rf0_axis_tvalid <= logical1_y_net;
  m_rf1_axis_tdata <= mux1_y_net;
  m_rf1_axis_tlast <= logical2_y_net;
  m_rf1_axis_tready_net <= m_rf1_axis_tready;
  m_rf1_axis_tvalid <= logical1_y_net;
  m_rf2_axis_tdata <= mux2_y_net;
  m_rf2_axis_tlast <= logical2_y_net;
  m_rf2_axis_tready_net <= m_rf2_axis_tready;
  m_rf2_axis_tvalid <= logical1_y_net;
  m_rf3_axis_tdata <= mux3_y_net;
  m_rf3_axis_tlast <= logical2_y_net;
  m_rf3_axis_tready_net <= m_rf3_axis_tready;
  m_rf3_axis_tvalid <= logical1_y_net;
  ...
  ce_net_x0 <= ce_51200;
  ctrl : entity xil_defaultlib.axi_qpsk_generator_ctrl 
  port map (
  ...
  m_axis_ch0 : entity xil_defaultlib.axi_qpsk_generator_m_axis_ch0 
  port map (
    tdata_in => mux_y_net,
    tvalid_in => logical1_y_net,
    tlast_in => logical2_y_net,
    m_rf0_axis_tready => m_rf0_axis_tready_net
  );
  m_axis_ch1 : entity xil_defaultlib.axi_qpsk_generator_m_axis_ch1 
  port map (
    tdata_in => mux1_y_net,
    tvalid_in => logical1_y_net,
    tlast_in => logical2_y_net,
    m_rf1_axis_tready => m_rf1_axis_tready_net
  );
  m_axis_ch2 : entity xil_defaultlib.axi_qpsk_generator_m_axis_ch2 
  port map (
    tdata_in => mux2_y_net,
    tvalid_in => logical1_y_net,
    tlast_in => logical2_y_net,
    m_rf2_axis_tready => m_rf2_axis_tready_net
  );
  m_axis_ch3 : entity xil_defaultlib.axi_qpsk_generator_m_axis_ch3 
  port map (
    tdata_in => mux3_y_net,
    tvalid_in => logical1_y_net,
    tlast_in => logical2_y_net,
    m_rf3_axis_tready => m_rf3_axis_tready_net
  );
  m_axis_fft : entity xil_defaultlib.axi_qpsk_generator_m_axis_fft 
  port map (
  ...
  m_axis_symbol : entity xil_defaultlib.axi_qpsk_generator_m_axis_symbol 
  port map (
  ...
  m_axis_time : entity xil_defaultlib.axi_qpsk_generator_m_axis_time 
  port map (
  ...
  posthb_time_domain : entity xil_defaultlib.axi_qpsk_generator_posthb_time_domain 
  port map (
    time_i_data => mux1_y_net_x1,
  ...
  post_hb_fft : entity xil_defaultlib.axi_qpsk_generator_post_hb_fft 
  port map (
    post_hb_i_data => mux1_y_net_x1,
  ...
  qpsk_symbol_mapper : entity xil_defaultlib.axi_qpsk_generator_qpsk_symbol_mapper 
  port map (
    bit_pairs => register_q_net,
    reset => slice1_y_net,
  ...
  rf_output : entity xil_defaultlib.axi_qpsk_generator_rf_output 
  port map (
    rf_i_data => delay5_q_net_x0,
    rf_i_valid => delay3_q_net,
    rf_i_last => delay4_q_net_x0,
    rf_q_data => delay5_q_net,
    rf_q_valid => delay3_q_net_x0,
    rf_q_last => delay4_q_net,
    rf_ch_sel => slice13_y_net,
    clk_1 => clk_net_x1,
    ce_1 => ce_net_x1,
    ch0_out => mux_y_net,
    tvalid_in => logical1_y_net,
  ...
  random_data_generator : entity xil_defaultlib.axi_qpsk_generator_random_data_generator 
  port map (
    enable => slice_y_net,
    reset => slice1_y_net,
    tready => down_sample1_q_net,
  ...
  symbol_2_output : entity xil_defaultlib.axi_qpsk_generator_symbol_2_output 
  port map (
  ...
  txinterp_i : entity xil_defaultlib.axi_qpsk_generator_txinterp_i 
  port map (
    ...
    post_hb_data => mux1_y_net_x1,
    post_hb_valid => delay_hb1_q_net
  );
  txinterp_q : entity xil_defaultlib.axi_qpsk_generator_txinterp_q 
  port map (
  ...
  down_sample1 : entity xil_defaultlib.axi_qpsk_generator_xldsamp 
  generic map (
    d_arith => xlUnsigned,
    d_bin_pt => 0,
    d_width => 1,
  ...
  logical : entity xil_defaultlib.sysgen_logical_939d3af5f6 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    d0 => m_rf0_axis_tready_net,
    d1 => m_rf1_axis_tready_net,
    d2 => m_rf2_axis_tready_net,
    d3 => m_rf3_axis_tready_net,
    d4 => slice11_y_net,
    y => logical_y_net
  );
  register2 : entity xil_defaultlib.axi_qpsk_generator_xlregister 
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_qpsk_generator_default_clock_driver is
  port (
    axi_qpsk_generator_sysclk : in std_logic;
    axi_qpsk_generator_sysce : in std_logic;
    axi_qpsk_generator_sysclr : in std_logic;
    axi_qpsk_generator_clk1 : out std_logic;
    axi_qpsk_generator_ce1 : out std_logic;
    axi_qpsk_generator_clk3200 : out std_logic;
    axi_qpsk_generator_ce3200 : out std_logic;
    axi_qpsk_generator_clk6400 : out std_logic;
    axi_qpsk_generator_ce6400 : out std_logic;
    axi_qpsk_generator_clk12800 : out std_logic;
    axi_qpsk_generator_ce12800 : out std_logic;
    axi_qpsk_generator_clk51200 : out std_logic;
    axi_qpsk_generator_ce51200 : out std_logic
  );
end axi_qpsk_generator_default_clock_driver;
architecture structural of axi_qpsk_generator_default_clock_driver is 
begin
  ...
  port map (
    sysclk => axi_qpsk_generator_sysclk,
    sysce => axi_qpsk_generator_sysce,
    sysclr => axi_qpsk_generator_sysclr,
    clk => axi_qpsk_generator_clk1,
    ce => axi_qpsk_generator_ce1
  );
  ...
  port map (
    ...
    sysce => axi_qpsk_generator_sysce,
    sysclr => axi_qpsk_generator_sysclr,
    clk => axi_qpsk_generator_clk3200,
    ce => axi_qpsk_generator_ce3200
  );
  ...
  port map (
    ...
    sysce => axi_qpsk_generator_sysce,
    sysclr => axi_qpsk_generator_sysclr,
    clk => axi_qpsk_generator_clk6400,
    ce => axi_qpsk_generator_ce6400
  );
  ...
  port map (
    ...
    sysce => axi_qpsk_generator_sysce,
    sysclr => axi_qpsk_generator_sysclr,
    clk => axi_qpsk_generator_clk12800,
    ce => axi_qpsk_generator_ce12800
  );
  ...
  port map (
    ...
    sysce => axi_qpsk_generator_sysce,
    sysclr => axi_qpsk_generator_sysclr,
    clk => axi_qpsk_generator_clk51200,
    ce => axi_qpsk_generator_ce51200
  );
end structural;
-- Generated from Simulink block 
library IEEE;
...
entity axi_qpsk_generator is
  port (
    ...
    m_time_axis_tready : in std_logic_vector( 1-1 downto 0 );
    clk : in std_logic;
    axi_qpsk_generator_aresetn : in std_logic;
    axi_qpsk_generator_s_axi_awaddr : in std_logic_vector( 7-1 downto 0 );
    axi_qpsk_generator_s_axi_awvalid : in std_logic;
    axi_qpsk_generator_s_axi_wdata : in std_logic_vector( 32-1 downto 0 );
    axi_qpsk_generator_s_axi_wstrb : in std_logic_vector( 4-1 downto 0 );
    axi_qpsk_generator_s_axi_wvalid : in std_logic;
    axi_qpsk_generator_s_axi_bready : in std_logic;
    axi_qpsk_generator_s_axi_araddr : in std_logic_vector( 7-1 downto 0 );
    axi_qpsk_generator_s_axi_arvalid : in std_logic;
    axi_qpsk_generator_s_axi_rready : in std_logic;
    m_rf0_axis_tdata : out std_logic_vector( 32-1 downto 0 );
    m_rf0_axis_tlast : out std_logic_vector( 1-1 downto 0 );
    m_rf0_axis_tvalid : out std_logic_vector( 1-1 downto 0 );
    m_rf1_axis_tdata : out std_logic_vector( 32-1 downto 0 );
    ...
    m_time_axis_tlast : out std_logic_vector( 1-1 downto 0 );
    m_time_axis_tvalid : out std_logic_vector( 1-1 downto 0 );
    axi_qpsk_generator_s_axi_awready : out std_logic;
    axi_qpsk_generator_s_axi_wready : out std_logic;
    axi_qpsk_generator_s_axi_bresp : out std_logic_vector( 2-1 downto 0 );
    axi_qpsk_generator_s_axi_bvalid : out std_logic;
    axi_qpsk_generator_s_axi_arready : out std_logic;
    axi_qpsk_generator_s_axi_rdata : out std_logic_vector( 32-1 downto 0 );
    axi_qpsk_generator_s_axi_rresp : out std_logic_vector( 2-1 downto 0 );
    axi_qpsk_generator_s_axi_rvalid : out std_logic
  );
end axi_qpsk_generator;
architecture structural of axi_qpsk_generator is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "axi_qpsk_generator,sysgen_core_2024_1,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu28dr,speed=-2-e,package=ffvg1517,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=5,system_simulink_period=3.90625e-08,waveform_viewer=1,axilite_interface=1,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=0.01,abs=2,addsub=1,cic_compiler_v4_0=2,cmult=3,concat=4,constant=24,convert=25,counter=7,delay=28,dsamp=1,fifo=3,fir_compiler_v7_2=6,inv=11,lfsr=2,logical=21,mcode=3,mult=4,mux=15,register=27,reinterpret=10,relational=12,shift=4,slice=14,usamp=40,xfft_forward=1,}";
  ...
  signal rf_ch_sel : std_logic_vector( 32-1 downto 0 );
  ...
  signal clk_net : std_logic;
begin
  axi_qpsk_generator_axi_lite_interface : entity xil_defaultlib.axi_qpsk_generator_axi_lite_interface 
  port map (
  ...
  axi_qpsk_generator_default_clock_driver : entity xil_defaultlib.axi_qpsk_generator_default_clock_driver 
  port map (
    axi_qpsk_generator_sysclk => clk_net,
    axi_qpsk_generator_sysce => '1',
    axi_qpsk_generator_sysclr => '0',
    axi_qpsk_generator_clk1 => clk_1_net,
    axi_qpsk_generator_ce1 => ce_1_net,
    axi_qpsk_generator_clk3200 => clk_3200_net,
    axi_qpsk_generator_ce3200 => ce_3200_net,
    axi_qpsk_generator_clk6400 => clk_6400_net,
    axi_qpsk_generator_ce6400 => ce_6400_net,
    axi_qpsk_generator_clk12800 => clk_12800_net,
    axi_qpsk_generator_ce12800 => ce_12800_net,
    axi_qpsk_generator_clk51200 => clk_51200_net,
    axi_qpsk_generator_ce51200 => ce_51200_net
  );
  axi_qpsk_generator_struct : entity xil_defaultlib.axi_qpsk_generator_struct 
  port map (
    autorestartfft => autorestartfft,
    autorestartsymbol => autorestartsymbol,
    autorestarttime => autorestarttime,
