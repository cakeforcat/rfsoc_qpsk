...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set IP_Name {Interleave64to128}
	set IP_Revision {372275620}
	set IP_Socket_IP {0}
	...
	set ProjectFiles {
		...
		{{interleave_ssr_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{interleave_ssr.vhd} -lib {xil_defaultlib}}
		{{interleave_ssr_clock.xdc}}
		{{interleave_ssr.xdc}}
	}
	...
	set TargetDir {C:/Users/cakef/Documents/GitHub/CoRSoC/IPs/Interleave_SSR/netlist/ip/Interleave_SSR/src}
	set TopLevelModule {interleave_ssr}
	...
	dict set TopLevelPortInterface s_q_axis_tvalid DatFile {interleave_interleave_ssr_s_q_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface s_q_axis_tvalid ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface s_q_axis_tdata Type UFix_64_0
	...
	dict set TopLevelPortInterface s_q_axis_tdata Width 64
	dict set TopLevelPortInterface s_q_axis_tdata DatFile {interleave_interleave_ssr_s_q_axis_tdata.dat}
	...
	dict set TopLevelPortInterface s_q_axis_tdata ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface s_i_axis_tvalid DatFile {interleave_interleave_ssr_s_i_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface s_i_axis_tvalid ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface s_i_axis_tdata Type UFix_64_0
	...
	dict set TopLevelPortInterface s_i_axis_tdata Width 64
	dict set TopLevelPortInterface s_i_axis_tdata DatFile {interleave_interleave_ssr_s_i_axis_tdata.dat}
	...
	dict set TopLevelPortInterface s_i_axis_tdata ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface m_axis_tready DatFile {interleave_interleave_ssr_m_axis_tready.dat}
	...
	dict set TopLevelPortInterface m_axis_tready ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface s_q_axis_tready DatFile {interleave_interleave_ssr_s_q_axis_tready.dat}
	...
	dict set TopLevelPortInterface s_q_axis_tready ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface m_axis_tdata Type UFix_128_0
	...
	dict set TopLevelPortInterface m_axis_tdata Width 128
	dict set TopLevelPortInterface m_axis_tdata DatFile {interleave_interleave_ssr_m_axis_tdata.dat}
	...
	dict set TopLevelPortInterface m_axis_tdata ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface m_axis_tvalid DatFile {interleave_interleave_ssr_m_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface m_axis_tvalid ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface s_i_axis_tready DatFile {interleave_interleave_ssr_s_i_axis_tready.dat}
	...
	dict set TopLevelPortInterface s_i_axis_tready ClockDomain {interleave_ssr}
	...
	dict set TopLevelPortInterface clk ClockDomain {interleave_ssr}
